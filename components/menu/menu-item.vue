    ...
    computed: {
      ...
      classes() {
        return [
          ...
          {
            [`${this.prefixCls}-menu-submenu-selected`]: this.selected && this.mode !== ENUM.MODE.INLINE,
            [`${this.prefixCls}-menu-item-selected`]: this.selected && this.mode === ENUM.MODE.INLINE,
